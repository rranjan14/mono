...
test('round trip', () => {
  ...
  expect(codes).toMatchInlineSnapshot(`
    [
      ".where('nudge', 'IS NOT', false).where('nudge', false).where('nudge', true).where('nudge', 'IS NOT', false).orderBy('nudge', 'asc').limit(161)",
      ".orderBy('airport', 'asc')",
      ".orderBy('surface', 'asc').limit(189)",
      ".where(({exists, not}) => not(exists('honesty', q => q.where(({exists, not}) => not(exists('character', q => q.where('complication', '>=', 4100258587552683).where('complication', 0.29166257870930323).orderBy('complication', 'asc')))).where('case', 'IS NOT', true).where('stump', '<', 5567851869464033).where('defendant', 'IS NOT', 'compello eaque alias').orderBy('intent', 'asc')))).where('diversity', false).related('honesty', q => q.where(({exists, not}) => not(exists('character', q => q.where('legend', '!=', 'arcus custodia villa').where('hello', 'IS NOT', 'vorago cunabula varius').where('toaster', '<', 7785446983784807).orderBy('complication', 'asc')))).where('best-seller', '<', 0.770921844644052).where('case', 'IS NOT', true).orderBy('intent', 'asc').limit(123)).orderBy('diversity', 'asc').limit(40)",
      ".whereExists('ownership', q => q.where('mixture', '<=', 0.17483862726041255).where('honesty', 'IS', 'acies appositus vix').orderBy('remark', 'asc')).where('allegation', '>=', 0.2160381825095996).where('exhaust', '!=', 7032475176166046).related('ownership', q => q.whereExists('printer', q => q.where(({exists, not}) => not(exists('maintainer', q => q.where('exhaust', '<', 4826306720255529).where('allegation', '<=', 0.7954499607897292).orderBy('allegation', 'asc')))).where('vista', 'IS', 'vestigium harum turbo').where('conservation', '>=', 7440555743576231).where('stitcher', 'IS', true).where('conservation', 3575691624737434).orderBy('vista', 'asc').orderBy('conservation', 'asc')).where('mixture', '<=', 0.2085105143573358).related('printer', q => q.whereExists('maintainer', q => q.where(({exists, not}) => not(exists('ownership', q => q.orderBy('remark', 'asc')))).where('exhaust', '>=', 5354566803250054).where('allegation', 'IS NOT', 3856879252438377).where('exhaust', '!=', 937736356344409).orderBy('allegation', 'asc'), {flip: true}).where('conservation', '>', null).where('stitcher', true).where('vista', 'IS NOT', 'canis harum utrum').orderBy('vista', 'asc').orderBy('conservation', 'asc').limit(64)).orderBy('mixture', 'asc').orderBy('honesty', 'asc').orderBy('suitcase', 'asc').orderBy('remark', 'asc')).orderBy('allegation', 'asc')",
      ".orderBy('language', 'asc').limit(147)",
      ".whereExists('zebra', q => q.where(({exists, not}) => not(exists('godparent', q => q.where(({exists, not}) => not(exists('ownership', q => q.where('following', 'IS NOT', true).where('nucleotidase', '<', 2434174811155864).orderBy('vol', 'asc').orderBy('nucleotidase', 'asc')))).where('overheard', '!=', true).where('overheard', 'IS', true).where('swine', 'IS NOT', 0.20131210782243325).where('pigpen', 'illo calcar vobis').orderBy('wheel', 'asc').orderBy('pigpen', 'asc')))).where('airport', '>=', 0.1248208139668483).where('airport', '>', 4167411365131850).where('airmail', '<=', 2574109428349849).where('contrail', 'IS NOT', true).orderBy('morning', 'asc')).where('impostor', 'ILIKE', 'tendo nam viscus').where('impostor', 'uberrime varietas advenio').related('zebra', q => q.whereExists('godparent', q => q.whereExists('pantyhose', q => q.where('chairperson', 'IS NOT', null).where('peony', '!=', 'neque adimpleo annus').where('vanadyl', 'IS', 'solio tutis stultus').where('vanadyl', 'LIKE', 'cohibeo testimonium decumbo').orderBy('chairperson', 'asc').orderBy('reservation', 'asc')).whereExists('ownership', q => q.where('nucleotidase', '>=', 0.7055858626438246).where('cappelletti', '>', 1284373868304998).orderBy('vol', 'asc').orderBy('nucleotidase', 'asc')).where('pigpen', 'sint repellendus confugo').where('wheel', 'IS', 'pecto copia blandior').where('swine', '<=', 248028722686261).where('overheard', 'IS NOT', true).orderBy('wheel', 'asc').orderBy('pigpen', 'asc'), {flip: true}).related('godparent', q => q.related('pantyhose', q => q.where('backbone', 'IS NOT', 'vicinus crux alias').related('pantyhose', q => q.where('vanadyl', 'charisma volup conatus').related('pantyhose', q => q.orderBy('chairperson', 'desc').orderBy('reservation', 'asc')).orderBy('peony', 'asc').orderBy('chairperson', 'asc').orderBy('reservation', 'asc').limit(7)).orderBy('ecliptic', 'desc').orderBy('bathrobe', 'asc').orderBy('chairperson', 'asc').orderBy('reservation', 'asc').limit(78)).related('ownership', q => q.where('nucleotidase', 'IS', 0.0015651051914729042).where('cappelletti', 5438505953821725).where('cappelletti', 3324134102564839).orderBy('vol', 'asc').orderBy('nucleotidase', 'asc').limit(150)).orderBy('wheel', 'asc').orderBy('pigpen', 'asc').limit(133)).orderBy('freckle', 'desc').orderBy('morning', 'asc')).orderBy('impostor', 'asc').limit(102)",
      ".whereExists('transom', q => q.whereExists('poetry', q => q.whereExists('orchid', q => q.where(({exists, not}) => not(exists('transom', q => q.where('valuable', '!=', 'beatae aequitas aegrotatio').where('gym', 'IS NOT', 'tondeo truculenter conatus').orderBy('bell', 'asc').orderBy('valuable', 'asc')))).where('solvency', 'IS NOT', 'fugit cimentarius currus').where('duster', '<', 3752091419856266).where('yogurt', 2739978480801073).orderBy('duster', 'asc').orderBy('cuckoo', 'asc')).where('hovel', 5972198171869894).orderBy('tapioca', 'asc')).where('assist', '<=', 6418722340397457).where('assist', '<', 0.8066935196947392).where('gym', 'LIKE', 'officiis solvo aeternus').orderBy('bell', 'asc').orderBy('valuable', 'asc')).where('solvency', '!=', 'viridis adicio cena').where('plain', '!=', 'ambulo doloribus dolor').orderBy('duster', 'desc').orderBy('cuckoo', 'asc').limit(161)",
      ".orderBy('disk', 'asc').orderBy('hovercraft', 'desc')",
      ".orderBy('legging', 'asc').orderBy('nougat', 'asc').limit(25)",
    ]
  `);
});
